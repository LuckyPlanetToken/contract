...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x63F8bEec23e44691Fb46E00cafe0159029d01b19;
...
contract MoochiiLotto is Context, IERC20, Ownable {
    ...
    string private _name = "LuckyPlanet";
    string private _symbol = "LuckyPlanet";
	...
	function addAddress(address adr) private {
		...
		function lotterize() private returns(address) {
